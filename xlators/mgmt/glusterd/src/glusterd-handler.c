                                ...
                                char *hostname)
{
        ...
        rsp.op_errstr = op_errstr ? op_errstr : "";
        rsp.hostname = hostname;
        // convert req and rsp(by xdr_gf1_cli_deprobe_rsp) and submit
        ret = glusterd_submit_reply (req, &rsp, NULL, 0, NULL,
...
{
		// use brickid to get volid to get volinfo
		// use brick and volinfo to get brickinfo
        glusterd_volinfo_t      *volinfo    = NULL;
        char                    *volid_str  = NULL;
        char                    *brick      = NULL;
                          ...
                          rpc_clnt_event_t event, void *data)
{
        ...
        case RPC_CLNT_CONNECT:
                ...
                // emit event
                // RPC_CLNT_CONNECT is corresponding GF_EVENT_CHILD_UP ?
                // if rpc is connected ,then every child xlator will get GF_EVENT_CHILD_UP
