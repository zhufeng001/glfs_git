...
glusterd_store_create_brick_shandle_on_absence (glusterd_volinfo_t *volinfo,
                                                glusterd_brickinfo_t *brickinfo)
{
		// create brick info shandle by brick path
        char                    brickpath[PATH_MAX] = {0,};
        int32_t                 ret = 0;
...
{
		// key from dict and where they come and ther the go ?
        int32_t                      ret = 0;
        int32_t                      exists = 0;
        gf_store_handle_t           *shandle = NULL;
        xlator_t                    *xl = NULL;
...
glusterd_store_brickinfos (glusterd_volinfo_t *volinfo, int vol_fd)
{
        ...
        list_for_each_entry (brickinfo, &volinfo->bricks, brick_list) {
        		// get brick info from volinfo->bricks
...
{
		// mv brick_path.tmp to brick_path
        int                      ret            = -1;
        glusterd_brickinfo_t    *brickinfo      = NULL;
